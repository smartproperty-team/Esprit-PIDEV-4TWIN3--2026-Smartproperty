// ===========================================
// SmartProperty - Facebook OAuth Callback Page
// ===========================================
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        // Store the tokens
        authService.handleFacebookCallback(accessToken, refreshToken);
        ...
        <div className="w-full max-w-md">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                {status === "loading" &&
                  "Please wait while we complete your Facebook sign-in."}
