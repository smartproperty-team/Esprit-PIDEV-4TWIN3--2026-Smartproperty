...
export const fr: Translations = {
  ...
  properties: {
    ...
    form: {
      ...
      aiDescription: {
        ...
        subtitle:
          "Générez du contenu marketing en plusieurs longueurs, tons et langues.",
        tone: "Ton",
        toneOptions: {
        ...
        lengths: "Longueurs",
        lengthOptions: {
          short: "Court (40-70 mots)",
          medium: "Moyen (90-140 mots)",
          long: "Long (170-240 mots)",
        },
        sourceLanguage: "Langue source",
        targetLanguages: "Langues cibles",
        hintKeywords: "Mots-clés (optionnel)",
        hintKeywordsPlaceholder: "lumineux, familial, calme",
        generate: "Générer",
  ...
  propertyDetail: {
    ...
    aiDescription: {
      ...
      generating: "Génération...",
      retry: "Réessayer",
      apply: "Appliquer à l'annonce",
      applied: "Description mise à jour",
      saveError: "Impossible d'enregistrer la nouvelle description.",
      close: "Fermer",
      errorGeneric: "La génération IA a échoué. Veuillez réessayer.",
